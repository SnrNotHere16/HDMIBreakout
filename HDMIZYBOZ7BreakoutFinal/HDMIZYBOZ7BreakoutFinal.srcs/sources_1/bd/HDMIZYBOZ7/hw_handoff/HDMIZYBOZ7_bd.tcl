...
################################################################
# This is a generated script based on design: HDMIZYBOZ7
#
...
# source HDMIZYBOZ7_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# BreakoutPixelGenerator, dvid_generator
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set LR [ create_bd_port -dir I -from 1 -to 0 LR ]
  set brickstaken [ create_bd_port -dir O -from 4 -to 0 brickstaken ]
  ...
  set gameover [ create_bd_port -dir O gameover ]
  set reset [ create_bd_port -dir I reset ]
  set speed [ create_bd_port -dir I -from 3 -to 0 speed ]
  set status [ create_bd_port -dir O status ]

  # Create instance: BreakoutPixelGenerat_0, and set properties
  set block_name BreakoutPixelGenerator
  set block_cell_name BreakoutPixelGenerat_0
  if { [catch {set BreakoutPixelGenerat_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $BreakoutPixelGenerat_0 eq "" } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_OUT2_PORT {clk_dvi} \
   CONFIG.CLK_OUT3_PORT {clk_dvin} \
  ...
  # Create instance: dvid_generator_0, and set properties
  set block_name dvid_generator
  set block_cell_name dvid_generator_0
  if { [catch {set dvid_generator_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $dvid_generator_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net BreakoutPixelGenerat_0_brickstaken [get_bd_ports brickstaken] [get_bd_pins BreakoutPixelGenerat_0/brickstaken]
  connect_bd_net -net BreakoutPixelGenerat_0_gameover [get_bd_ports gameover] [get_bd_pins BreakoutPixelGenerat_0/gameover] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net BreakoutPixelGenerat_0_rgb_next [get_bd_pins BreakoutPixelGenerat_0/rgb_next] [get_bd_pins dvid_generator_0/g_rgb]
  connect_bd_net -net BreakoutPixelGenerat_0_status [get_bd_ports status] [get_bd_pins BreakoutPixelGenerat_0/status]
  connect_bd_net -net LR_1 [get_bd_ports LR] [get_bd_pins BreakoutPixelGenerat_0/LR]
  connect_bd_net -net axi_gpio_0_ip2intc_irpt [get_bd_pins axi_gpio_0/ip2intc_irpt] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_pins BreakoutPixelGenerat_0/player_name] [get_bd_pins axi_gpio_2/gpio_io_o]
  connect_bd_net -net btn1_1 [get_bd_ports btn1] [get_bd_pins BreakoutPixelGenerat_0/btn1]
  connect_bd_net -net clk_in_1 [get_bd_ports clk_in] [get_bd_pins BreakoutPixelGenerat_0/clk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins dvid_generator_0/clk_in]
  connect_bd_net -net clk_wiz_0_clk_dvi [get_bd_pins clk_wiz_0/clk_dvi] [get_bd_pins dvid_generator_0/clk_dvi]
  connect_bd_net -net clk_wiz_0_clk_dvin [get_bd_pins clk_wiz_0/clk_dvin] [get_bd_pins dvid_generator_0/clk_dvin]
  connect_bd_net -net clk_wiz_0_clk_vga [get_bd_pins BreakoutPixelGenerat_0/tick] [get_bd_pins clk_wiz_0/clk_vga] [get_bd_pins dvid_generator_0/clk_vga]
  connect_bd_net -net dvid_generator_0_clk_n [get_bd_ports clk_n] [get_bd_pins dvid_generator_0/clk_n]
  connect_bd_net -net dvid_generator_0_clk_p [get_bd_ports clk_p] [get_bd_pins dvid_generator_0/clk_p]
  connect_bd_net -net dvid_generator_0_data_n [get_bd_ports data_n] [get_bd_pins dvid_generator_0/data_n]
  connect_bd_net -net dvid_generator_0_data_p [get_bd_ports data_p] [get_bd_pins dvid_generator_0/data_p]
  connect_bd_net -net dvid_generator_0_h_video [get_bd_pins BreakoutPixelGenerat_0/h_video] [get_bd_pins dvid_generator_0/h_video]
  connect_bd_net -net dvid_generator_0_pix_x [get_bd_pins BreakoutPixelGenerat_0/pixel_x] [get_bd_pins dvid_generator_0/pix_x]
  connect_bd_net -net dvid_generator_0_pix_y [get_bd_pins BreakoutPixelGenerat_0/pixel_y] [get_bd_pins dvid_generator_0/pix_y]
  connect_bd_net -net dvid_generator_0_v_video [get_bd_pins BreakoutPixelGenerat_0/v_video] [get_bd_pins dvid_generator_0/v_video]
  ...
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins BreakoutPixelGenerat_0/reset] [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins clk_wiz_0/reset] [get_bd_pins dvid_generator_0/reset]
  ...
  connect_bd_net -net speed_1 [get_bd_ports speed] [get_bd_pins BreakoutPixelGenerat_0/speed]
